...
<div class="col-sm-9 col-md-9 col-lg-6 mx-auto" role="columnheader">
    ...
    <div class="card card-signin my-5">
        ...
        <div class="card-body" style="padding:60px 20px">
            <h5 class="card-title text-center text-success" role="heading">Search Enquiry</h5>
            <!-- form -->

            <form action="/searchenquiry/search" method="GET">
                ...
                <div class="row" style="margin-bottom:30px; margin-top:30px">
                    <div class="col-sm-9 col-md-9 col-lg-8 mx-auto">
                        <div class="form-label-group">
                            ...
                            {!! Form::text('search_result' , null , ['class'=>'form-control ' , 'placeholder'=>'Enter Phone no, Name' , 'style'=>'padding:10px']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
