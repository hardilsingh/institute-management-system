...
<div class="col-sm-9 col-md-9 col-lg-6 mx-auto" role="columnheader">
    ...
    <div class="card card-signin my-5">
        ...
        <div class="card-body" style="padding:60px 20px">
            <h5 class="card-title text-center text-success" role="heading">Add Book</h5>
            <!-- form -->
                ...
                <div class="row" style="margin-bottom:30px; margin-top:30px">
                    <div class="col-sm-9 col-md-9 col-lg-8 mx-auto">
                        <div class="form-label-group">
                            ...
                            {!! Form::text('name' , null , ['class'=>'form-control ' , 'placeholder'=>'Enter book name' , 'style'=>'padding:10px']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="margin-bottom:30px; margin-top:30px">
                    <div class="col-sm-9 col-md-9 col-lg-8 mx-auto">
                        <div class="form-label-group">
                            ...
                            {!! Form::number('total' , null , ['class'=>'form-control ' , 'placeholder'=>'Enter total stock' , 'style'=>'padding:10px']) !!}
                        </div>
                    </div>
                </div>
                <div class="row">
